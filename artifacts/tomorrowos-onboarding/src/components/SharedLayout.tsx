    ...
    <div className="min-h-[100dvh] flex flex-col bg-background">
      {state.prototypeReviewMode && (
        <div className="bg-amber-100 border-b border-amber-200 text-amber-900 px-4 py-2 text-sm flex items-center justify-center gap-2 text-center">
          ...
          <span><strong>Prototype simulation</strong> — These states are simulated for review and are not connected to Replit, Supabase, Cloudinary, your CMS or a physical device.</span>
        </div>
      )}
